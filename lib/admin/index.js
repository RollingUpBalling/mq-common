...
exports.getTaycCommand = exports.getMoonshotCommand = exports.AdminCommand = void 0;
var AdminCommand;
...
var getMoonshotCommand = function (command) {
    return "moonshot:".concat(command);
};
exports.getMoonshotCommand = getMoonshotCommand;
var getTaycCommand = function (command) { return "tayc:".concat(command); };
exports.getTaycCommand = getTaycCommand;
